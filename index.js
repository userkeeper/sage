...
const RU_PERSONAS = [
  ...
  { id: "morgenshtern", name: "Моргенштерн", fact: "в апреле 2024 запер девушку на балконе в израильском отеле, забрал все девайсы и объявил что он Мессия и пойдёт войной на Путина, станет президентом России и Украины одновременно — у него диагностированы шизотипическое и биполярное расстройства, он годами употреблял кокаин, кетамин и литры алкоголя, его девушка получила диабет первого типа от нервов и чуть не умерла одна дома, а когда рассказала ему об этом — он ответил что был бы рад её смерти потому что она была бы ближе к Богу, при этом сам лежал в рехабе с психозом и праздновал 200 дней трезвости пока его имущество арестовывали и объявляли в розыск" },
